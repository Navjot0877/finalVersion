...
//Fetching all the details of Checked Out Product
  useEffect(()=> {
    ...
    Axios.get("https://luminous-liquor.herokuapp.com/productInfo/" + location.state.id).then((response)=>{
...
var payPrice = "25.98";
    ...
    const [subTotal, setSubTotal] = useState((parseFloat(
      (price*parseInt(location.state.quantity)).toFixed(2))) );
