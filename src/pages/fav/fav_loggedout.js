...
// Declaring UseStates
    ...
    useEffect(()=> {
          ...
          Axios.get("https://luminous-liquor.herokuapp.com/readFav/" + 2).then((response)=>{
...
// alert(id)
    Axios.post("https://luminous-liquor.herokuapp.com/delFav/" + id)
...
<div className='reqf'><a href="/login">Sign in to see your favourites</a></div>
