...
const SignupInput = () => {
  ...
  const registerMe = () => {
    ...
    if (name && email && password && phone && age) {
      ...
      load(false);
      axios.post("https://luminous-liquor.herokuapp.com/register", user).then((res) => {
...
<FloatingLabel
      ...
      <label >
        You have an account? Login <Button className="butReg" onClick={()=>navigate("/login")}>Here</Button>
      </label>
      </div>
