...
const Input = () =>{
    ...
    useEffect(() =>{
        axios.get('https://luminous-liquor.herokuapp.com/currentUser')
        .then(res => {
            //console.log(res)
    ...
    const editData = async (e) =>{
        ...
        const url = 'https://luminous-liquor.herokuapp.com/edituser/' + currentUser._id
...
<FloatingLabel
      ...
      >
         ...
         onChange={getFullName} />
            ...
            <button className='editbutton' onClick={editData }>Edit</button> <button className='deletebutton' onClick={deleteData}>Delete</button>
        </form>
        </div>;
        </div>
        </>
