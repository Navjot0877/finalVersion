...
import Pay2 from "./pages/pay/pay2";
import Searchresult from "./SearchResults/pages/Searchresult";
import AboutUs from "../src/AboutUs/pages/AboutUs"
import ProductRequest from "./ProductRequest/page/ProductRequest";
...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <Route exact path="/pay2" element={<Pay2 />}>
      
        
      </Route>

      <Route exact path="/request" element={<ProductRequest />}>
